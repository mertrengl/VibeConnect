        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.passwordChecklist}>
            ...
            <div className={`${styles.checkItem} ${rules.hasLowercase ? styles.checkItemPassed : ""}`}>
              <span className={`${styles.checkIcon} ${rules.hasLowercase ? styles.checkItemPassed : styles.checkIconPending}`}>
                {rules.hasLowercase ? "✓" : "○"}
              </span>
            ...
            <div className={`${styles.checkItem} ${rules.hasSymbol ? styles.checkItemPassed : ""}`}>
              <span className={`${styles.checkIcon} ${rules.hasSymbol ? styles.checkItemPassed : styles.checkIconPending}`}>
                {rules.hasSymbol ? "✓" : "○"}
              </span>
